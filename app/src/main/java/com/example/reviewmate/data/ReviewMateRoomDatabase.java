...
public abstract class ReviewMateRoomDatabase extends RoomDatabase {
    ...
    private static void populateInitialData(ReviewMateRoomDatabase instance) {
        ...
        databaseWriteExecutor.execute(() -> {
            ...
            movieDAO.insert(new Movie("Inception", "2010-07-16", "Action, Sci-Fi", 148, 8.8f, 9.1f, "A thief who steals corporate secrets through the use of dream-sharing technology.", "Christopher Nolan", "Leonardo DiCaprio, Joseph Gordon-Levitt", "English", "USA", "https://i.ibb.co/b5kPxZX/Inception.jpg", "https://www.youtube.com/embed/YoHD9XEInc0", "PG-13", 160000000L, 836848102L));
            movieDAO.insert(new Movie("The Dark Knight", "2008-07-18", "Action, Crime", 152, 9.0f, 9.2f, "When the menace known as the Joker wreaks havoc.", "Christopher Nolan", "Christian Bale, Heath Ledger", "English", "USA", "https://i.ibb.co/bvTtJZC/The-Dark-Knight.jpg", "https://www.youtube.com/embed/EXeTwQWrcwY", "PG-13", 185000000L, 1004558444L));
